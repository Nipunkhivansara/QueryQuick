        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '50px' }}>
            ...
            >
                ...
                <DialogContent sx={{marginTop: '20px'}}>
                    <TextField sx={{margin: '10px'}} label="Outlined secondary" color="secondary" focused fullWidth />
                    <TextField sx={{margin: '10px'}} label="Filled success" variant="filled" color="success" focused />
                    <TextField
                        sx={{margin: '10px'}}
